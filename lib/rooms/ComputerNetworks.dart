...
class ComputerNetworks extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new Room(false, "Computer Networks Lab", Colors.blue, "Baskin Engineering 1 Room 301A", "Computer Engineering", _desc, "https://goo.gl/maps/p9Ad1aoFfeR2", Icons.computer, "images/compnet.jpg");
  }
}