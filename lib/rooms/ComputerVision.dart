...
class ComputerVision extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new Room(false, "Computer Vision Lab", Colors.orange, "Baskin Engineering 2 Room 209","Computer Science" , _desc, "https://goo.gl/maps/pmfgaXssnju", Icons.computer, "images/computervision.jpg");
  }
}
