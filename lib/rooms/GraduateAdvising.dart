...
class GraduateAdvising extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new Room(false, "Graduate Advising Office", Colors.deepPurple, "Oakes Academic Building Room 221", "Graduate Division", _desc, "https://goo.gl/maps/wXfHPRYCo7y", Icons.school, "images/baskin.jpg");
  }
}
