...
class Nanopore extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new Room(false, "Nanopore Lab", Colors.purple, "Baskin Engineering 1 Room 217", "Bioengineering", _desc, "https://goo.gl/maps/a3YEtuuqP3T2", Icons.nature_people, "images/nanopore.jpg");
  }
}
