...
class MechLab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new Room(false, "Mechatronics Lab", Colors.blue, "Baskin Engineering 1 Room 115", "Computer Engineering", _desc, "https://goo.gl/maps/uAmKmPfxjb22", Icons.computer, "images/mech.jpg");
  }
}
